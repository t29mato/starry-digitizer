...
import { AxisExtractionResult } from '../axisExtractorInterface'
...
export class AxisExtractorManager {
  ...
  setUseColorThreshold(useColorThreshold: boolean): void {
    this.axisExtractor.setUseColorThreshold(useColorThreshold)
  }

  setMinSolidity(solidity: number): void {
    this.axisExtractor.setMinSolidity(solidity)
  }
